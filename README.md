...
![User Collection](/design/screenshots/user_collection.png)


Each Post will need to specify if they are offering or finding help which will help to filter it when people are searching up the post. Username so we can get the email off them and title and description so people can know what the post is about. Last of all when it was posted so that users can sort it the most recent if they wish. 

![Post Collection](/design/screenshots/posts_collection.png)
...
#### Search posts 
To make the website as easy as possible users can search for the posts they are looking for. 
...
The aim of the app is to bring people together by looking or seeing how they can help each other.
...
People can only add a post if they are logged in and have to log in to edit a post
...
I want to add a filter section where people can filter what they want and sort them however they want. I want to add a location section in the future so people can search by what's closest to them 

#### Email user or chartroom with users  
I want to add a chatroom or email section where users can communicate easier to each other rather than have there emails there. 

#### Reset Username and / or Password 
I want to add a place where users can get reminded of their usernames through there emails and update there passwords with secuurity measures added for them to go through there email first. 
...
### Links all checked 
I went through every link to make sure it works and that every link goes to the right page

### Adding and updating posts
I added and updated posts on both mongo db and through the forms on the html to make sure it works.

### Making sure 
### Validators
I've used a validator for very language used and made sure they had no errors.
...
#### Anyone can add a post even if they didn't have an account  
